...
var SS = SpreadsheetApp.openById('1VQc8FKEsdeADAcw8kn_Wzpv2qZIwT-F_psfsDDbFzF9fY');    //Enter Your Sheet ID Got From Sheet URL Link
var sheet = SS.getSheetByName('Temp_Data_Sheet');      // Enter your sheet name here, In my case it is Temp_Data_Sheet
var str = "";

function onOpen(){
  var ui = SpreadsheetApp.getUi();
  ui.createMenu('ESP8266_Temp_Data_Logger')
  .addItem('Clear', 'Clear')
  .addToUi();
}
...
function Clear(){
  ...
  SS.toast('Chart cleared', 'ESP8266_Temp_Data_Logger', 5);
}
